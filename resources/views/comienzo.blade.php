        ...
        <div class="relative flex items-top justify-center min-h-screen bg-green-100  dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <a href="{{ url('seleccionar') }}" class="text-sm text-blue-900 no-underline">Iniciar sesion</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-blue-900 no-underline">Registrarse</a>
                        @endif
                    @endauth
                </div>
            @endif
            ...
            <div class="max-w-6xl mx-auto sm:px-10 lg:px-10">
                <div class="flex justify-center pt-10 sm:justify-start sm:pt-10 ">
                    <div class="row">
                    <p class="text-8xl text-center font-serif Georgia text-blue-900">
                                Tienda 
                    </p>
                    <br>
                    <p class="text-8xl text-center font-serif Georgia text-blue-900">
